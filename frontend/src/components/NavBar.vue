                    ...
                    <VRow align="center" justify="center">
                        ...
                        <VCol cols="10"  align="center"   > 
                            ...
                            <RouterLink class="route" :to="{ name: 'Home' }" >
                                <VBtn class="text-subtitle-3"   density="compact"  color="primary" :variant="(route.name == 'Home')? 'tonal':'text'">Home</VBtn>
                            </RouterLink>

                            <RouterLink class="route" :to="{ name: 'Live' }" >
                                <VBtn class="text-subtitle-3"   density="compact"  color="primary" :variant="(route.name == 'Live')? 'tonal':'text'">Live</VBtn>
                            </RouterLink>

                            <RouterLink class="route" :to="{ name: 'Analysis' }" >
                                <VBtn class="text-subtitle-3"   density="compact"  color="primary" :variant="(route.name == 'Analysis')? 'tonal':'text'">Analysis</VBtn>
                            </RouterLink>
                        </VCol>
